...
I18N.ru = {
    ...
    hero_subtitle:'5 направлений экспертизы для трансформации и масштабирования вашего бизнеса',
    ...
    srv_label:'Экспертиза', srv_title_1:'5 направлений', srv_title_2:'для вашего роста',
    ...
    srv_3_title:'Креатив',
    srv_3_desc:'Маркетинг (основное направление), продажи и развитие клиентов, дизайн и брендинг, кадры и организации (HR)',
    srv_4_title:'Аналитика и Данные',
    ...
    page_desc:'Профессиональный бизнес-консалтинг в 5 направлениях: управление, инвестиции, креатив, аналитика, IT.',
    page_desc_calc:'Рассчитайте стоимость консалтинговых услуг онлайн. 5 направлений экспертизы.',
    currency_symbol:'₽',
...
I18N.en = {
    ...
    hero_subtitle:'5 areas of expertise to transform and scale your business',
    ...
    srv_label:'Expertise', srv_title_1:'5 directions', srv_title_2:'for your growth',
    ...
    srv_3_title:'Creative', srv_3_desc:'Marketing (core), sales & client development, design & branding, HR & organization',
    srv_4_title:'Analytics & Data', srv_4_desc:'Business analytics, BI systems, forecasting, data visualization, risk assessment and data-driven management',
    ...
    page_desc:'Professional business consulting in 5 areas: management, investment, creative, analytics, IT.',
    page_desc_calc:'Calculate the cost of consulting services online. 5 areas of expertise.',
    currency_symbol:'\u20bd',
